    ...
    <section class="py-2 ">
        ...
        <div class="container max-w-7xl px-2 mx-auto">
            <div id="match-container" class="grid-cols-1 sm:grid md:grid-cols-3 ">
                ...
                <div class="match-card-display  mx-3 mt-6 flex flex-col rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-gray-800 sm:shrink-0 sm:grow sm:basis-0">
                    ...
                    <div class="p-5">
                        ...
                        <p class=" text-base text-neutral-600 dark:text-neutral-200">
                            Experience the thrill at , where
                            and
                            face off in an epic showdown on Don't miss the action secure your tickets now and join us for an unforgettable match day! Buy your tickets today to witness the magic live in the stadium!
                        </p>
                    </div>
                    <div class="p-3 flex justify-end">
                        <a href="buyTicket\index\" class="text-primary-100 border border-primary-100 py-2 px-3 rounded inline-flex  items-center">
                            View wiki
                ...
                <div class="match-card-display  mx-3 mt-6 flex flex-col rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-gray-800 sm:shrink-0 sm:grow sm:basis-0">
                    <a href="#!">
                        <img class="rounded-t-lg" src="public/assets/images/article.jpg" alt="football" />
                    </a>
                    <div class="p-5">
                        <h5 class="mb-2 text-xl font-medium leading-tight text-neutral-800 dark:text-neutral-50">
                            lorme vs lurem
                ...
                <div class="match-card-display  mx-3 mt-6 flex flex-col rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-gray-800 sm:shrink-0 sm:grow sm:basis-0">
                    ...
                    <div class="p-3 flex justify-end">
                        <a href="articles" class="text-primary-100 border border-primary-100 py-2 px-3 rounded inline-flex  items-center">
                            View wiki
                            <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" class="w-6 h-6 ml-2">
                                <path d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
                            </svg>
