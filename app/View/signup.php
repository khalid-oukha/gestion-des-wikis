...
<div class="contain py-16">
  <div class="max-w-lg mx-auto shadow px-6 py-7 rounded overflow-hidden">
    ...
    <form autocomplete="off">
      ...
      <div class="space-y-2">
        <div><label for="email" class="text-gray-600 mb-2 block dark:text-gray-100 "></label class="dark:text-gray-100">Full Name<input type="email" name="email" id="email" class="block w-full border border-gray-300 px-4 py-3 text-gray-600 text-sm rounded focus:ring-0 focus:border-teal-500 placeholder-gray-400" placeholder="youremail.@domain.com">
        </div>
      </div>
      <div class="space-y-2">
      ...
      <div class="space-y-2">
        <div><label for="email" class="text-gray-600 mb-2 block dark:text-gray-100 "></label class="dark:text-gray-100">Password<input type="email" name="email" id="email" class="block w-full border border-gray-300 px-4 py-3 text-gray-600 text-sm rounded focus:ring-0 focus:border-teal-500 placeholder-gray-400" placeholder="youremail.@domain.com">
        </div>
      </div>
      <div class="space-y-2">
        <div><label for="email" class="text-gray-600 mb-2 block dark:text-gray-100 "></label class="dark:text-gray-100">Birthday<input type="email" name="email" id="email" class="block w-full border border-gray-300 px-4 py-3 text-gray-600 text-sm rounded focus:ring-0 focus:border-teal-500 placeholder-gray-400" placeholder="youremail.@domain.com">
        </div>
      </div>
      <div class="space-y-2">
