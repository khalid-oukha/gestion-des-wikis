...
<body class="bg-gray-300 dark:bg-gray-900">
    ...
    <main id="main" class=" pt-16 px-28">
        <h2 class="my-6 text-4xl font-semibold text-center font-poppins tracking-widest text-gray-700 dark:text-gray-200">
            <span class="text-primary-100 dark:text-orange">Tags</span> - Management
        </h2>
                ...
                <table class="w-full border-collapse border border-gray-300 dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                    <thead>
                        <tr class="bg-gray-200">
                            <th class="border-y border-gray-100 bg-gray-50/50 p-2 dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800"> Add Tags</th>
                        </tr>
                    </thead>
                            ...
                            <tr class="text-gray-700 dark:text-gray-400">
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center space-x-4 text-sm">
                                        <a href="<?=URL_DIR?>tags/updateTag/<?=$tag['id'] ?>">
                                        ...
                                        <a href="tags/deleteTag/<?= $tag['id'] ?>" onclick="return confirm('Do you really want to Delete ?');">
