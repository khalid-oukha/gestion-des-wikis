...
<body class="bg-gray-300 dark:bg-gray-900">
    ...
    <main id="main" class=" pt-16 px-28">
        <h2 class="my-6 text-4xl font-semibold text-center font-poppins tracking-widest text-gray-700 dark:text-gray-200">
            <span class="text-primary-100 dark:text-orange">UPDATE</span> - TAG
        </h2>

        <form  action="\wikis\tags\submitUpdateTag" method="post">
                ...
                <table class="w-full border-collapse border border-gray-300 dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800">
                    ...
                    <tbody id="attendees-list">
                        <tr>
                            ...
                            <input class="p-2 px-10 rounded border dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800" name="id" value="<?=$tags['id']?>" type="hidden" />
   
                            <input class="p-2 px-10 rounded border dark:border-gray-700 bg-gray-50 dark:text-gray-400 dark:bg-gray-800" name="NAME" value="<?= $tags['NAME']?>" type="text" />
                            </td>
                        </tr>
