        ...
        <div class="flex text-white items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            ...
            <div>
                ...
                <div id="theme-toggler">
                    <button aria-label="theme-toggle" id="theme-toggle" type="button" class=" dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5">
